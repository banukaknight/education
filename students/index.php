...
if(isset($_POST['student_signin']))
{
	...
	$st_password = preg_replace("/[^A-Za-z0-9 .,'@£$!%*#?&_]/", '', $st_password);
					...
					<div class="login-wrap p-0">
						...
						<form  method="post">
							<div class="form-group">
								<input name="st_username" type="text" class="form-control" placeholder="Username" required>
							</div>
							<div class="form-group">
								<input name="st_password" id="password-field" type="password" class="form-control" placeholder="Password"
									required>
								<span toggle="#password-field"
									class="fa fa-fw fa-eye field-icon toggle-password"></span>
							</div>
							<div class="form-group">
								<button name="student_signin" type="submit" class="form-control btn btn-primary submit px-3">Sign In</button>
							</div>
